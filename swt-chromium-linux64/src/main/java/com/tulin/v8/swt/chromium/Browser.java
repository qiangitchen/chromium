...
public class Browser extends Composite {
	...
	public Browser(Composite parent, int style) {
		...
		String msg = "";
		try {
			webBrowser = (WebBrowser) Class.forName("com.tulin.v8.swt.chromium.Chromium").newInstance();
	 ...
	 * 
	 * @param script  the script with javascript commands
	 * @param trusted <code>true</code> or <code>false</code> depending on the
	 ...
	 * 
	 * @return HTML representing the current page or an empty <code>String</code> if
	 *         this is empty.<br>
	 *         <p>
	 *         Note, the exact return value is platform dependent. For example on
	 *         Windows, the returned string is the proccessed webpage with
	 *         javascript executed and missing html tags added. On Linux and OS X,
	 *         this returns the original HTML before the browser has processed it.
	 *         </p>
	 * @exception SWTException
	 *                         <ul>
	 *                         <li>ERROR_THREAD_INVALID_ACCESS when called from the
